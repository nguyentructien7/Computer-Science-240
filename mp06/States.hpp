...
private:
     ...
     */
    BinarySearchTree<StateIndex<string>> abbreviationBst;
    BinarySearchTree<StateIndex<string>> nameBst;
    BinarySearchTree<StateIndex<string>> capitalBst;
    BinarySearchTree<StateIndex<int>> populationBst;
    BinarySearchTree<StateIndex<int>> areaBst;
    BinarySearchTree<StateIndex<int>> yearInductedBst;
    BinarySearchTree<StateIndex<int>> orderInductedBst;
    /*---------------------------------------------------------------------------------*/
    ...
    static void display(StateIndex<K>& e) {
        //cout << e.state->name << ":" << e.sortField << endl;
        cout << *e.state;
