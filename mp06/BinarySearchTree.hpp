...
private:
    ...
    public:
        ...
        TreeNode(TreeNode* const left, const E& e, TreeNode* const right)
        : left(left), element(e), right(right)
        {}
    };
    /*-----------------------------------------------------------------------*/
    ...
    void inorder(TreeNode * const r, FunctionPointer visit) const {
        ...
        if (r) {
            ...
            visit(r->element); //visit must be a function that, when called on an element, can print the elemnt
